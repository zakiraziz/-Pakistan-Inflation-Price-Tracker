...
ITEMS = [
    ...
    ("Rice (Irri-6)", "Grocery", "per kg", 165, 1.00, 0.03, 1.20),
    ("Cooking oil", "Grocery", "per 5 L", 2400, 1.05, 0.04, 2.00),
    ("Vegetable ghee", "Grocery", "per kg", 590, 1.15, 0.04, 1.90),
    ("Gram lentil (chana daal)", "Grocery", "per kg", 265, 1.08, 0.03, 0.90),
    ("Mash lentil", "Grocery", "per kg", 430, 1.05, 0.03, 1.60),
    ("Masoor lentil", "Grocery", "per kg", 285, 1.05, 0.03, 2.10),
    ("Gram flour (besan)", "Grocery", "per kg", 275, 1.05, 0.03, 0.60),
    ("Tea (packed)", "Grocery", "per kg", 1950, 1.25, 0.02, 0.00),
    ("Onion", "Fresh produce", "per kg", 110, 1.00, 0.28, 0.50),
    ("Potato", "Fresh produce", "per kg", 60, 1.00, 0.20, 2.50),
    ("Tomato", "Fresh produce", "per kg", 110, 1.00, 0.35, 2.20),
    ("Garlic", "Fresh produce", "per kg", 480, 0.95, 0.10, 1.30),
    ("Ginger", "Fresh produce", "per kg", 380, 1.00, 0.15, 0.40),
    ("Banana", "Fresh produce", "per dozen", 150, 1.00, 0.10, 1.10),
    ("Apple", "Fresh produce", "per kg", 260, 1.00, 0.12, 2.80),
    ...
    ("Yogurt (curd)", "Dairy & protein", "per kg", 200, 1.05, 0.05, 0.30),
    ("Beef", "Dairy & protein", "per kg", 850, 1.10, 0.03, 0.50),
    ("Mutton", "Dairy & protein", "per kg", 2300, 1.08, 0.05, 0.90),
    ("Petrol (super)", "Energy", "per litre", 268, 1.10, 0.04, 0.30),
    ("Diesel (high speed)", "Energy", "per litre", 288, 1.10, 0.05, 0.60),
    ("LPG", "Energy", "per kg", 250, 1.08, 0.06, 1.00),
